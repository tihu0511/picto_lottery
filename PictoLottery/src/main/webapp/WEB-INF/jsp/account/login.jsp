...
<div class="login_form">
	...
	<form action="<%=request.getContextPath()%>/doLogin.do" method="post">
		<dl class="login_table">
			...
			<dt>验证码</dt>
			<dd><input type="text" name="validCode" style="width:60px;" maxlength="4" /> <img src="<%=request.getContextPath()%>/verifyImage.do" valign="middle" onclick="refreshVericode(this.id)" /></dd>
		</dl>
